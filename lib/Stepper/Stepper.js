...
var Stepper = _react2.default.createClass({
  ...
  propTypes: {
     ...
     */
    activeStepIndex: _react.PropTypes.number,
     ...
     */
    updateCompletedStatusOfStep: _react.PropTypes.func
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    ...
    var controlButtonsGroupNode = this.refs.controlButtonsGroup;

    if (containerWrapperNode.style.height === '0px' && nextProps.activeStepIndex > -1) {
      containerWrapperNode.style.height = childrenWrapperNode.offsetHeight + controlButtonsGroupNode.offsetHeight + 40 + 'px';
  ...
  getStylesForHorizontalStepper: function getStylesForHorizontalStepper() {
    ...
    var activeStepIndex = _props.activeStepIndex;


    var itemWidth = this.state.itemWidth;
    var translateX = -activeStepIndex * itemWidth;
  ...
  renderHorizontalStepper: function renderHorizontalStepper() {
    ...
    var activeStepIndex = _props2.activeStepIndex;
    var updateCompletedStatusOfStep = _props2.updateCompletedStatusOfStep;
    var hoveredHeaderStepIndex = this.state.hoveredHeaderStepIndex;


    var setOfChildrens = [];
    var setOfControlButtonsGroup = [];
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            setOfChildrens.map(function (children, index) {
              return _react2.default.createElement(
                'div',
        ...
        _react2.default.createElement(
          'div',
          { style: { padding: 20, display: 'flex', justifyContent: 'flex-end' }, ref: 'controlButtonsGroup' },
  ...
  renderVerticalStepper: function renderVerticalStepper() {
    ...
    var activeStepIndex = _props3.activeStepIndex;
    var updateCompletedStatusOfStep = _props3.updateCompletedStatusOfStep;
    var hoveredHeaderStepIndex = this.state.hoveredHeaderStepIndex;
