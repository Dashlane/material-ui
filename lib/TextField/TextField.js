...
var TextField = _react2.default.createClass({
  ...
  getInitialState: function getInitialState() {
    var propsLeaf = this.props.children ? this.props.children.props : this.props;
  ...
  _handleTextAreaHeightChange: function _handleTextAreaHeightChange(event, height) {
    var newHeight = height / getFontSize(this.props) + 1.5;
    if (this.props.floatingLabelText) newHeight += 1.5;
    _reactDom2.default.findDOMNode(this).style.height = newHeight + 'em';
  },
