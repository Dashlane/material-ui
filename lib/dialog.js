...
var warning = process.env.NODE_ENV !== 'production' ? require('warning') : function () {};
...
var Dialog = React.createClass({
  ...
  getInitialState: function getInitialState() {
    ...
    var open = this.props.isOpen;

    if (open === null) open = this.props.openImmediately || this.props.defaultIsOpen;
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps, nextContext) {
    ...
    if (nextProps.isOpen !== this.props.isOpen) {
      if (nextProps.isOpen && !this.state.open) this._show();else if (!nextProps.isOpen && this.state.open) this._dismiss();
    }
  },
  ...
  _testDeprecations: function _testDeprecations() {
    if (process.env.NODE_ENV !== 'production') {
      warning(!this.props.hasOwnProperty('openImmediately'), 'openImmediately has been deprecated in favor of defaultIsOpen');

      warning(!this.props.hasOwnProperty('onShow'), 'onShow will be removed in favor of explicitly setting isOpen');

      warning(!this.props.hasOwnProperty('onDismiss'), 'onDismiss will be removed in favor of explicitly setting isOpen and can be replaced by onRequestClose');

      warning(!this.props.hasOwnProperty('modal'), 'modal will be removed in favor of explicitly setting isOpen and onRequestClose');
    }
  },
  ...
  show: function show() {
    if (process.env.NODE_ENV !== 'production') warning(false, 'show has been deprecated in favor of explicitly setting the isOpen property.');
  ...
  dismiss: function dismiss() {
    if (process.env.NODE_ENV !== 'production') warning(false, 'dismiss has been deprecated in favor of explicitly setting the isOpen property.');
  ...
  _requestClose: function _requestClose(buttonClicked) {
    if (process.env.NODE_ENV !== 'production') warning(!this.props.hasOwnProperty('modal'), 'modal will be removed in favor of explicitly setting isOpen and onRequestClose');
