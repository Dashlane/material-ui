...
function getStyles(props, state) {
  ...
  var backgroundColor = props.backgroundColor || raisedButton.color;
  var labelColor = props.labelColor || raisedButton.textColor;
  ...
  var overlayBackgroundColor = state.hovered && !disabled && _colorManipulator2.default.fade(labelColor, amount);
